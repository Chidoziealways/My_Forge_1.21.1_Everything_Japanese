...
public class YamazakiBerryBushBlock extends SweetBerryBushBlock {
    public YamazakiBerryBushBlock(Properties properties) {
        super(properties);
    }
    ...
    protected InteractionResult useWithoutItem(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer, BlockHitResult pHitResult) {
        ...
        if (i > 1) {
            ...
            popResource(pLevel, pPos, new ItemStack(ModItems.YAMAZAKI_BERRIES.get(), j + (flag ? 1 : 0)));
