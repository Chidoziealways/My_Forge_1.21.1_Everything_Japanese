...
public class YaProjectileEntity extends AbstractArrow {
    private static final int EXPOSED_POTION_DECAY_TIME = 600;
    private static final int NO_EFFECT_COLOR = -1;
    private static final EntityDataAccessor<Integer> ID_EFFECT_COLOR = SynchedEntityData.defineId(YaProjectileEntity.class, EntityDataSerializers.INT);
    private static final byte EVENT_POTION_PUFF = 0;

    public YaProjectileEntity(EntityType<? extends AbstractArrow> entityType, Level level) {
        super(entityType, level);
    }

    public YaProjectileEntity(Level pLevel, double pX, double pY, double pZ, ItemStack pPickupItemStack, @Nullable ItemStack pFiredFromWeapon) {
        super(ModEntities.YA.get(), pX, pY, pZ, pLevel, pPickupItemStack, pFiredFromWeapon);
        this.updateColor();
    }

    public YaProjectileEntity(Level pLevel, LivingEntity pOwner, ItemStack pPickupItemStack, @Nullable ItemStack pFiredFromWeapon) {
        super(ModEntities.YA.get(), pOwner, pLevel, pPickupItemStack, pFiredFromWeapon);
        this.updateColor();
    }
    ...
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItems.YA.get());
    }
