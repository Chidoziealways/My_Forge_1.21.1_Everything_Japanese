...
public class ModArmorMaterials {
    ...
    public static final ArmorMaterial PYRITE = new ArmorMaterial(
            ...
            Util.make(new EnumMap<>(ArmorType.class),
                    ...
                    10f,0.1f, ItemTags.REPAIRS_GOLD_ARMOR, ModEquipmentAssets.PYRITE);

    public static final ArmorMaterial NEPHRITE = new ArmorMaterial(1000000, Util.make(new EnumMap<>(ArmorType.class),
                    attribute -> {
                    ...
                    }), 20, SoundEvents.ARMOR_EQUIP_DIAMOND,  50f,0.1f, ItemTags.REPAIRS_NETHERITE_ARMOR, ModEquipmentAssets.NEPHRITE);

    static {
        System.out.println("DEBUG: Tag for NEPHRITE_ARMOR_MATERIAL = " + ModTags.Items.REPAIRS_NEPHRITE_ARMOR);
    }

    public static final ArmorMaterial SAMURAI_ARMOR_MATERIAL = new ArmorMaterial(100000000, Util.make(new EnumMap<>(ArmorType.class),
                    attribute -> {
                        attribute.put(ArmorType.BOOTS, 5);
                    ...
                    }), 15, SoundEvents.ARMOR_EQUIP_IRON,4f, 0.1f, ItemTags.REPAIRS_IRON_ARMOR, ModEquipmentAssets.SAMURAI);
}