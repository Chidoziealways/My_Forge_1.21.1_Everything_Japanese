...
public class ModArmorItem extends ArmorItem {
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.PYRITE_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.JUMP, 200, 1, false, false),
                                    ...
                                    new MobEffectInstance(ModEffects.ADRENALINE_EFFECT.getHolder().get(), 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 200, 1, false, false)))

                    .put(ModArmorMaterials.NEPHRITE_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.JUMP, 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.GLOWING, 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.HEALTH_BOOST, 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 200, 1, false, false),
                                    new MobEffectInstance(ModEffects.ADRENALINE_EFFECT.getHolder().get(), 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.CONDUIT_POWER, 200, 2, true, false)))

                    .put(ModArmorMaterials.SAMURAI_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.JUMP, 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.GLOWING, 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.HEALTH_BOOST, 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 200, 1, false, false),
                                    new MobEffectInstance(ModEffects.ADRENALINE_EFFECT.getHolder().get(), 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.ABSORPTION, 200, 1, false, false)))
                    .build();
