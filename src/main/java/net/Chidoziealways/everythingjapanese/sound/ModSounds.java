...
public class ModSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, EverythingJapanese.MOD_ID);
    ...
    public static final RegistryObject<SoundEvent> AO_TO_NATSU = registerSoundEvent("ao_to_natsu");
    public static final ResourceKey<JukeboxSong> AO_TO_NATSU_KEY = ResourceKey.create(Registries.JUKEBOX_SONG,
            ResourceLocation.fromNamespaceAndPath(EverythingJapanese.MOD_ID, "ao_to_natsu"));


    private static RegistryObject<SoundEvent> registerSoundEvent(String name){
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EverythingJapanese.MOD_ID, name)));
    }
