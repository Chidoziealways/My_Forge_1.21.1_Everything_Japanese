...
object Config {
    ...
    private val ITEM_STRINGS: ForgeConfigSpec.ConfigValue<MutableList<out String?>?> = BUILDER
    ...
    private fun validateItemName(obj: Any?): Boolean {
        return obj is String && ForgeRegistries.ITEMS.containsKey(ResourceLocation.tryParse(obj))
    }
    ...
    fun onLoad(event: ModConfigEvent?) {
        ...
        items = strings.stream()
            .map<Item?> { id: String? -> ForgeRegistries.ITEMS.getValue(ResourceLocation.tryParse(id)) }
