...
object ModBlockEntities {
    ...
    val PEDESTAL_BE: RegistryObject<BlockEntityType<PedestalBlockEntity?>?>? =
        BLOCK_ENTITIES.register<BlockEntityType<PedestalBlockEntity?>?>("pedestal_be", Supplier {
            val type: BlockEntityType<PedestalBlockEntity?> =
                ...
                }, Set.of<Block?>(ModBlocks.PEDESTAL.get()))
    ...
    val GROWTH_CHAMBER_BE: RegistryObject<BlockEntityType<GrowthChamberBlockEntity?>?>? =
        BLOCK_ENTITIES.register<BlockEntityType<GrowthChamberBlockEntity?>?>("growth_chamber_be", Supplier {
