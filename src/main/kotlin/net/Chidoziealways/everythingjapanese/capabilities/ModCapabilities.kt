...
object ModCapabilities {
    ...
    val CHAKRA_CAPABILITY: EntityCapability<IChakra, Void?> =
        EntityCapability.createVoid(ResourceLocation.fromNamespaceAndPath(JAPANESE_MOD_ID, "chakra"), IChakra::class.java)
    val STAMINA_CAPABILITY: EntityCapability<IStaminaCapability, Void?> =
        EntityCapability.createVoid(ResourceLocation.fromNamespaceAndPath(JAPANESE_MOD_ID, "stamina"), IStaminaCapability::class.java)
    val JUTSU_CAPABILITY: EntityCapability<IJutsuCapability, Void?> =
        EntityCapability.createVoid(ResourceLocation.fromNamespaceAndPath(JAPANESE_MOD_ID, "jutsu"), IJutsuCapability::class.java)
    @JvmField
    val LOCK_CAPABILITY: BlockCapability<ISealLock, Void?> =
        BlockCapability.createVoid(ResourceLocation.fromNamespaceAndPath(JAPANESE_MOD_ID, "seal"), ISealLock::class.java)
    val MONEY_CAPABILITY_ENTITY: EntityCapability<IMoneyCapability, Void?> =
        EntityCapability.createVoid(ResourceLocation.fromNamespaceAndPath(JAPANESE_MOD_ID, "money_entity"), IMoneyCapability::class.java)
    val MONEY_CAPABILITY_BLOCK: BlockCapability<IMoneyCapability, Void?> =
        BlockCapability.createVoid(ResourceLocation.fromNamespaceAndPath(JAPANESE_MOD_ID, "money_block"), IMoneyCapability::class.java)
    val MONEY_CAPABILITY_ITEM: ItemCapability<IMoneyCapability, Void?> =
        ItemCapability.createVoid(ResourceLocation.fromNamespaceAndPath(JAPANESE_MOD_ID, "money_item"), IMoneyCapability::class.java)
}
