...
class CursedSamuraiModel: GeoModel<CursedSamurai>() {
    override fun getModelResource(renderState: GeoRenderState?): ResourceLocation? {
        return ResourceLocation.fromNamespaceAndPath(JAPANESE_MOD_ID, "cursed_samurai/cursed_samurai")
    }

    override fun getTextureResource(renderState: GeoRenderState?): ResourceLocation? {
        return ResourceLocation.fromNamespaceAndPath(JAPANESE_MOD_ID, "textures/entity/cursed_samurai/cursed_samurai.png")
    }
