...
enum class BladeType(val id: String, val displayName: String, val material: ToolMaterial, val overlay: Identifier) {
    STEEL("steel", "Steel", ModToolMaterials.STEEL, Identifier.fromNamespaceAndPath(JAPANESE_MOD_ID, "item/blade_steel"));
