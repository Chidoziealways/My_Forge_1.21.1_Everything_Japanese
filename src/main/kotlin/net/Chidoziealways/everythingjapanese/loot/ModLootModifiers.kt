...
object ModLootModifiers {
    ...
    val ADD_ITEM: RegistryObject<MapCodec<out IGlobalLootModifier?>?>? =
        LOOT_MODIFIER_SERIALIZERS.register<MapCodec<out IGlobalLootModifier?>?>(
            "add_item",
            Supplier { AddItemModifier.Companion.CODEC })
