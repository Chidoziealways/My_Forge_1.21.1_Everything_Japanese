...
object ModRegistries {
    val JUTSU_KEY: ResourceKey<Registry<Jutsu>> =
        ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(JAPANESE_MOD_ID, "jutsu"))

    val JUTSU: Registry<Jutsu> = RegistryBuilder(JUTSU_KEY)
        .sync(true)
        .defaultKey(Identifier.fromNamespaceAndPath(JAPANESE_MOD_ID, "small_fireball"))
        .maxId(256)
        .create()

    val KANJI: ResourceKey<Registry<KanjiType>> =
        ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(JAPANESE_MOD_ID, "kanji"))
    ...
    val MORPHS: Registry<MobMorph> = RegistryBuilder(MORPHS_KEY)
        .sync(true)
        .defaultKey(Identifier.fromNamespaceAndPath(JAPANESE_MOD_ID, "blaze"))
        .maxId(256)
        .create()
}
