    ...
    fun bootstrap(context: BootstrapContext<BiomeModifier>) {
        ...
        context.register(
            ADD_PYRITE_ORE, BiomeModifiers.AddFeaturesBiomeModifier(
                ...
                HolderSet.direct(placedFeature.getOrThrow(JModPlacedFeatures.PYRITE_ORE_PLACED_KEY)),
        ...
        context.register(
            ADD_NEPHRITE_ORE, BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct<PlacedFeature>(placedFeature.getOrThrow(JModPlacedFeatures.NEPHRITE_ORE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES
            )
        )
        ...
        context.register(
            ADD_HINOKI_TREE, BiomeModifiers.AddFeaturesBiomeModifier(
                ...
                HolderSet.direct<PlacedFeature>(placedFeature.getOrThrow(JModPlacedFeatures.HINOKI_PLACED_KEY)),
        ...
        context.register(
            ADD_YAMAZAKI_BERRY_BUSH, BiomeModifiers.AddFeaturesBiomeModifier(
                ...
                HolderSet.direct<PlacedFeature>(placedFeature.getOrThrow(JModPlacedFeatures.YAMAZAKI_BERRY_BUSH_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION
            )
        )
        ...
        context.register(
            SPAWN_CURSED_SAMURAI, BiomeModifiers.AddSpawnsBiomeModifier(
                ...
                WeightedList.of(SpawnerData(ModEntities.CURSED_SAMURAI, 9, 100))
            )
        )
